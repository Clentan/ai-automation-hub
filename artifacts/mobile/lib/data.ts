...
export const SERVICES: Record<string, ServiceMeta> = {
  ...
  notion: { label: 'Notion', icon: 'file-text', color: '#37352f' },
  slack: { label: 'Slack', icon: 'hash', color: '#611f69' },
  jira: { label: 'Jira', icon: 'trello', color: '#0052cc' },
  github: { label: 'GitHub', icon: 'github', color: '#24292e' },
  trello: { label: 'Trello', icon: 'trello', color: '#0079bf' },
  'google-drive': { label: 'Google Drive', icon: 'hard-drive', color: '#0f9d58' },
  discord: { label: 'Discord', icon: 'message-circle', color: '#5865f2' },
  microsoft: { label: 'Microsoft', icon: 'grid', color: '#00a4ef' },
};

export function serviceMeta(id: string): ServiceMeta {
  return SERVICES[id] ?? { label: id, icon: 'box', color: '#64748b' };
}
...
export const TEMPLATES: Template[] = [
  {
    ...
    description:
      'Automatically analyzes incoming emails and generates draft replies using OpenAI, saving them in Gmail.',
  ...
  },
  {
    ...
    description:
      'Keep your team in the loop by sending a Slack notification whenever specific Notion databases are modified.',
    author: 'AI Automation Hub',
    type: 'Automated',
  ...
  },
  {
    ...
    description:
      'Uses AI to analyze expense reports and automatically approves them if they fall under the low-risk threshold.',
    author: 'AI Automation Hub',
    type: 'Automated',
  ...
  },
  {
    ...
    description:
      'Automatically extracts attachments from incoming emails and organizes them into Google Drive folders by sender.',
    author: 'AI Automation Hub',
    type: 'Automated',
