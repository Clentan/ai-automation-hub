    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-background">
      <div className="bg-background sticky top-0 z-10 px-6 py-5 [@media(min-height:820px)]:py-8 md:[@media(min-height:820px)]:py-10">
        <div className="max-w-7xl 2xl:max-w-[1500px] mx-auto w-full flex items-start gap-4">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl [@media(min-height:820px)]:md:text-4xl font-bold tracking-tight mb-2 text-foreground">My Active Flows</h1>
      ...
      <div className="flex-1 overflow-auto bg-secondary/10">
        <div className="p-6 md:p-8 max-w-7xl 2xl:max-w-[1500px] mx-auto w-full space-y-4 pb-10 [@media(min-height:820px)]:pb-20">
          {flows.length === 0 ? (
